...
class UserItemClass extends PureComponent {
    ...
    render() {
        return (
            <TouchableOpacity onPress={() => {this.props.navigation.navigate('ProfilePages', {pubId: this.props.item.pubId})}} style={{minHeight: 70, maxHeight: 70, borderColor: this.props.colors.borderColor, borderTopWidth: this.props.index === 0 ? 1 : 0, borderBottomWidth: 1}}>
